...
angular.module('angularjs_with_Nodejs').controller('hccbController', function ($rootScope,$scope, $timeout, $filter, $http) {
    ...
    setTimeout(function ()
    {
        ...
        // $.post('/retailers', {'name': 'Marwad Retailers','address':'Sankhwas-Nagur Rd, Nabawas,Rajasthan 341021,India','latitude': '27.13467167', 'longitude': '73.68568096', 'distributor' : 1 }, function (data) {
        //     console.log("---Retailers POST Response ---: ", data);
        // });
        ...
        //Working PUT
        // $.put('/retailers', {'_id':'5b335dafb399641b962336f4','name': 'Pratik Retailers','address':'Sankhwas-Nagur Rd, Nabawas,Rajasthan 341021,India','latitude': '27.13467167', 'longitude': '73.68568096', 'distributor' : 1 }, function (data) {
        //     console.log("---Retailers PUT Response ---: ", data);
        // });
    }, 100);
    ...
    $scope.initMap = function ()
    {
        ...
        center: new google.maps.LatLng(26.979059, 75.556741),
        zoom: 11, 
...
{
    console.log("---YourAngularController---:");
    //http://dataservice.accuweather.com/currentconditions/v1/3352256?apikey=gOqBgSUgJVQiK6KcZKbTZdCWdYMgAGQo&language=en-us&details=true 
    //http://www.iNorthwind.com/Service1.svc/getAllCustomers
    $http({ method: 'GET', url: 'http://dataservice.accuweather.com/currentconditions/v1/3352256?apikey=gOqBgSUgJVQiK6KcZKbTZdCWdYMgAGQo&language=en-us&details=true' }).
    success(function (data, status, headers, config) {
        console.log("---status---:",status);
        console.log("---data---:",data);
        console.log("---data---:",data[0].WeatherText);
        // console.log("---data.length---:",data.GetAllCustomersResult.length);
        // for (var i = 0, length = data.GetAllCustomersResult.length; i < length; i++) 
        // {
        //     console.log("---City---:",data.GetAllCustomersResult[i].City);
        // }
    }).
    error(function (data, status, headers, config) {
        console.log("---status---:",status);
