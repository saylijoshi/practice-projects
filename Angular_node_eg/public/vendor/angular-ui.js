 ...
 */
angular.module('ui.directives').directive('uiAnimate', ['ui.config', '$timeout',
...
angular.module('ui.directives').directive('uiCalendar', ['ui.config', '$parse',
 ...
 */
angular.module('ui.directives').directive('uiCodemirror', ['ui.config', '$timeout',
    function(uiConfig, $timeout) {
        'use strict';
 ...
 */
angular.module('ui.directives').directive('uiCurrency', ['ui.config', 'currencyFilter',
...
angular.module('ui.directives')
    ...
    .directive('uiDateFormat', ['ui.config',
        function(uiConfig) {
            var directive = {
                require: 'ngModel',
 ...
 */
angular.module('ui.directives').directive('uiJq', ['ui.config', '$timeout',
...
angular.module('ui.directives').factory('keypressHelper', ['$parse',
 ...
 **/
angular.module('ui.directives').directive('uiKeydown', ['keypressHelper',
...
angular.module('ui.directives').directive('uiKeypress', ['keypressHelper',
    function(keypressHelper) {
        return {
            link: function(scope, elm, attrs) {
...
angular.module('ui.directives').directive('uiKeyup', ['keypressHelper',
    function(keypressHelper) {
        return {
            link: function(scope, elm, attrs) {
...
(function() {
    ...
    app.directive('uiMap', ['ui.config', '$parse',
        function(uiConfig, $parse) {
    ...
    app.directive('uiMapInfoWindow', ['ui.config', '$parse', '$compile',
 ...
 */
angular.module('ui.directives').directive('uiReset', ['ui.config',
    function(uiConfig) {
        var resetValue = null;
 ...
 */
angular.module('ui.directives').directive('uiRoute', ['$location', '$parse',
 ...
 */
angular.module('ui.directives').directive('uiScrollfix', ['$window',
    function($window) {
        'use strict';
        return {
            link: function(scope, elm, attrs) {
 ...
 */
angular.module('ui.directives').directive('uiSelect2', ['ui.config', '$timeout', '$compile',
    function(uiConfig, $timeout, $compile) {
        var options = {};
        if (uiConfig.select2) {
        ...
        return {
            ...
            compile: function(tElm, tAttrs) {
                ...
                return function(scope, elm, attrs, controller) {
                    ...
                    if (angular.isDefined(attrs.buttonText) && angular.isDefined(attrs.buttonCallback) && attrs.buttonText !== '' && attr.buttonAllowAdd === 'true') {
                        opts.formatNoMatches = function (value) {
                            scope.dropdown.dynaSelectAddItem = value;
                            var node = $compile("<button type='button' ng-click='" + attrs.buttonCallback + "'>" + attrs.buttonText + "</button>")(scope);
                            return node;
                        };
                    }//if
 ...
 */
angular.module('ui.directives').directive('uiTinymce', ['ui.config',
    function(uiConfig) {
