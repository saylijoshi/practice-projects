		...
		return {
			...
			link: function(originalScope, element, attrs, ngModel) {
				...
				scope.dateSelection = function() {
					...
					ngModel.$render();
                    originalScope.$parent.$broadcast('datePickerValueChanged',attrs.name,attrs.ngModel);
...
.controller('PaginationController', ['$scope', '$attrs', '$parse', '$interpolate', 'hotkeys',
	function($scope, $attrs, $parse, $interpolate, hotkeys) {
		var self = this,
        ...
        /**
         * Removed as per Satish's instruction
         * @param page
         */
...
//                        $scope.selectPage(currentSelectedPage);
//                    }//if
//                }
//            })
//            .add({
...
//                callback: function() {
//                    if (currentSelectedPage < $scope.totalPages) {
//                        currentSelectedPage += 1;
//                        $scope.selectPage(currentSelectedPage);
//                    }//if
//                }
...
angular.module("template/accordion/accordion-group.html", []).run(["$templateCache",
	function($templateCache) {
		$templateCache.put("template/accordion/accordion-group.html",
			...
			"  <div class=\"panel-heading\" ><a class=\"accordion-toggle\" ng-class='{ open: isOpen}' ng-click=\"isOpen = !isOpen\" accordion-transclude=\"heading\"><i class='fa fa-plus-circle'> </i> {{heading}}</a> <span class='hdate'>{{date}}</span></div>\n" +
...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache",
	function($templateCache) {
		$templateCache.put("template/datepicker/datepicker.html",
			...
			" <th><button type=\"button\" class=\"btn-icon pull-left\" ng-click=\"move(-1)\"><i class=\"icon-chevron-left\"></i></button></th>\n" +
			" <th colspan=\"{{rows[0].length - 2 + showWeekNumbers}}\"><button type=\"button\" class=\"btn btn-block\" ng-click=\"toggleMode()\"><strong>{{title}}</strong></button></th>\n" +
			" <th><button type=\"button\" class=\"btn-icon pull-right\" ng-click=\"move(1)\"><i class=\"icon-chevron-right\"></i></button></th>\n" +
			" </tr>\n" +
			" <tr class=\"text-center\" ng-show=\"labels.length > 0\">\n" +
			" <th ng-show=\"showWeekNumbers\">Wk</th>\n" +
...
angular.module("template/datepicker/popup.html", []).run(["$templateCache",
	function($templateCache) {
		$templateCache.put("template/datepicker/popup.html",
			...
			//            " <button class=\"btn \" ng-click=\"showWeeks = ! showWeeks\" ng-class=\"{active: showWeeks}\">Weeks</button>\n" +       hidding ng-class  by avinash
			" <button class=\"btn \" ng-click=\"showWeeks = ! showWeeks\">Weeks</button>\n" +
			" <button class=\"btn \" ng-click=\"clear()\">Clear</button>\n" +
			" </span>\n" +
			" <button class=\"btn pull-right\" ng-click=\"isOpen = false\">Close</button>\n" +
			" </li>\n" +
			"</ul>");
	}
]);
...
angular.module("template/pagination/pagination.html", []).run(["$templateCache",
	function($templateCache) {
		$templateCache.put("template/pagination/pagination.html",
            ...
            " <li class=\"disabled\"><a>Total - {{totalItems}}</a></li>\n"+
			" </ul>\n" +
			"</div>\n" +
			"");
	}
...
angular.module("template/tabs/pane.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("template/tabs/tabs.html", []).run(["$templateCache",
	function($templateCache) {
